...
import PlaygroundScene from '../components/instrumental/PlaygroundScene';
import ControlPanel from '../components/instrumental/ControlPanel';
import { getInstrumentAccompaniment, getInstrumentTransformation } from '../services/geminiService';

const InstrumentalPlayground: React.FC = () => {
...
export default InstrumentalPlayground;
